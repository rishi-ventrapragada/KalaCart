...
class MockLiveStreamingService implements LiveStreamingService {
  ...
  Future<void> connectToRoom({
    ...
    // Callers subscribe to the broadcast streams right after calling connect;
    // yield one microtask so those listeners exist before the first events.
  ...
  void _startSimulations() {
    // Restarting a room must not leak the previous timers.
